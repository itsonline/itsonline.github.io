...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="/beritapublishpemred" class="nav__link">
                        <i class='bx bx-grid-alt nav__icon' ></i>
                        <span class="nav__name">Berita Publish</span>
                    </a>

                    <a href="/beritasetiapstafpemred" class="nav__link active">
    ...
    <br/>
    <div class="container">
        <a href="/beritasetiapstafpemred/tambahberitasetiapstafpemred"> + Tambah Berita Setiap Staf Baru</a>
	<br/>
	<br/>
	...
	<table class="table table-hover">
		...
		<tr>
            ...
            <td>{{ $bss->volArtikel }}</td>
            <td>{{ $bss->totalPendapatan }}</td>
            <td>{{ $bss->tglTerimaHonor }}</td>
            <td>{{ $bss->jmlhKehadiran }}</td>
            <td>
                <a href="/beritasetiapstafpemred/editberitasetiapstafpemred/{{ $bss->IDHasilBeritaStaf }}">Edit</a>
                |
                <a href="/beritasetiapstafpemred/hapuspemred/{{ $bss->IDHasilBeritaStaf  }}">Hapus</a>
            </td>
		</tr>
        @endforeach
        </thead>
