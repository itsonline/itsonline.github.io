...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="inventarisbarangredaktur" class="nav__link active">
    ...
    <br/>
    <div class="container">
        <a href="/inventarisbarangredaktur/tambahinventarisredaktur" style="font-size:20px"> + Tambah Peminjaman Baru</a>
	<br/>
	<br/>
	...
	<table class="table table-hover">
		...
		<tr>
            ...
            <td>{{ $ib->tglKembali }}</td>
			<td>
				<a href="/inventarisbarangredaktur/editinventarisredaktur/{{ $ib->kodePinjam }}">Edit</a>
			</td>
		</tr>
        @endforeach
        </thead>
