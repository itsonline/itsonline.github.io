...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="/daftarberitakorlip" class="nav__link active">
    ...
    <br/>
    <div class="container">
        <a href="/daftarberitakorlip/tambahdaftarberitakorlip" style="font-size:20px"> + Tambah Daftar Berita Baru</a>
	<br/>
	<br/>
	...
	<table class="table table-hover">
		...
		<tr>
            ...
            <td>{{ $db->narsum }}</td>
			<td>
				<a href="/daftarberitakorlip/editdaftarberitakorlip/{{ $db->kodeBerita }}">Edit</a>
			</td>
		</tr>
        @endforeach
        </thead>
