...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="/penulisanberitapemred" class="nav__link active">
    ...
    <br/>
    <div class="container">
        <a href="/penulisanberitapemred/tambahpenulisanberitapemred"> + Tambah Penulisan Berita Baru</a>
	<br/>
	<br/>
	...
	<table class="table table-hover">
		...
		<tr>
			...
			<td>
                <a href="/penulisanberitapemred/editpenulisanberitapemred/{{ $pb->IDPenulisan }}">Edit</a>
                |
				<a href="/penulisanberitapemred/hapuspemred/{{ $pb->IDPenulisan }}">Hapus</a>
			</td>
		</tr>
        @endforeach
        </thead>
