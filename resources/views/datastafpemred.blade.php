...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    <a href="/datastafpemred" class="nav__link active">
    ...
    <br/>
    <div class="container">
        <a href="/datastafpemred/tambahdatastafpemred"> + Tambah Penulisan Berita Baru</a>
	<br/>
	<br/>
	...
	<table class="table table-hover">
		...
		<tr>
            ...
            <td>{{ $ds->email }}</td>
			<td>
                <a href="/datastafpemred/editdatastafpemred/{{ $ds->kodeStaf }}">Edit</a>
			</td>
		</tr>
        @endforeach
        </thead>
