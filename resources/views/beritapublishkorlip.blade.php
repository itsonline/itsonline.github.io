...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="/beritapublishkorlip" class="nav__link active">
    ...
    <br/>
    <div class="container">
        <a href="beritapublishkorlip/tambahberitapublishkorlip/" style="font-size:20px"> + Tambah Berita Publish Baru</a>
	<br/>
	<br/>
	...
	<table class="table table-hover">
		...
		<tr>
			...
			<td>{{ $bp->link }}</td>
			<td>
                <a href="beritapublishkorlip/editberitapublishkorlip/{{ $bp->kodeBerita }}">Edit</a>
			</td>
		</tr>
        @endforeach
        </thead>
