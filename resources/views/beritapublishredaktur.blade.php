...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="/beritapublishredaktur" class="nav__link active">
                    ...
                    <a href="/penulisanberitaredaktur" class="nav__link">
    ...
    <br/>
    <div class="container">
        <a href="beritapublishredaktur/tambahberitapublishredaktur/" style="font-size:20px"> + Tambah Berita Publish Baru</a>
	<br/>
	<br/>
	...
	<table class="table table-hover">
		...
		<tr>
			...
			<td>{{ $bp->link }}</td>
			<td>
                <a href="beritapublishredaktur/editberitapublishredaktur/{{ $bp->kodeBerita }}">Edit</a>
			</td>
		</tr>
        @endforeach
        </thead>
